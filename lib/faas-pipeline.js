...
const logger = require('@getlazy/common').createPackageLogger('faas-pipeline');
...
class FaasPipeline extends EventEmitter {
	...
	* @param {Array} `functions` An array of function objects on which the requested task can be performed.
